...
//#define FOREGROUND_STAR_IMAGE_NAME @"xingxing"
...
- (instancetype)initWithFrame:(CGRect)frame {
    return [self initWithFrame:frame numberOfStars:DEFALUT_STAR_NUMBER imageName: self.imagename]  ;
}
...
- (instancetype)initWithFrame:(CGRect)frame numberOfStars:(NSInteger)numberOfStars imageName:(NSString *)imagename {
...
- (void)buildDataAndUI {
    ...
    self.foregroundStarView = [self createStarViewWithImage:self.imagename];
